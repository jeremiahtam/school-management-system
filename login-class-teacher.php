...
<title>Class Teacher Login | School</title>
...
<body class="login-landing class-teacher-landing">
    ...
    <section class="login-bg">
      <div class="container">
        <div class="panel login-box">
          ...
          <div class="panel-heading">Login as a class teacher</div>
          
          <div class="panel-body">
 
            <div class="login-info"></div>
            
            <form method="post" id="login-form-class-teacher" name="login-form-class-teacher">
...
$(document).ready(function() {
   $('#login-form-class-teacher').validate({
	  rules:{
 	       username:{
		     required:true,
		     minlength:5
	  ...
	  submitHandler:function(form){
		 $.ajax({
			 ...
			 data:$('#login-form-class-teacher').serialize()+"&userType=class-teacher",
			 beforeSend: function(){
			 ...
			 success: function(info){
				 ...
				 if(!info){
					 window.location.href="subject-result";
					 }
