...
<body class="login-landing student-landing">
          ...
          <div class="panel-body">
            ...
            <form method="post" id="login-form-student" name="login-form-student">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="username" name="username" placeholder="Admission Number">
              </div>
              <div class="form-group">
                <label for="password">Password</label>
								<span class='help-block'>In the format SURNAME/Date Of Birth in the format SURNAME/DD/MM/YYYY eg. ROBINSON/05/12/1997</span>
              ...
              <img src='img/ajax-loader.gif' class="preloader" width='22px' height='22px' hidden="true"/></button>
						...
						<h6 class="text-warning"><strong>NOTICE!</strong> For best performance, use a CHROME browser!</h6>
						<h6 class="text-info">Contact 09082267471 in case of any difficulties.</h6>
          </div><!--end panel-body-->
   ...
   $('#login-form-student').validate({
	  ...
	  submitHandler:function(form){
		 $.ajax({
			 ...
			 data:$('#login-form-student').serialize()+"&userType=student",
			 beforeSend: function(){
